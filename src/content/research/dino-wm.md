...
draft: false
graphLabel: "DINO-WM"
graphDescription: "Zhou et al. (2024). Uses frozen DINOv2 patch features as WM backbone — no reconstruction, no reward model. Trained offline on trajectories; zero-shot planning via action sequence optimization at test time. LeCun/Pinto group."
graphEdges:
