...
graphEdges:
  ...
  - target: atari
    label: evaluated on
graphDescription: "Dabney et al. (2017). Extends C51 by representing the return distribution with fixed-probability quantiles learned via quantile regression loss, enabling flexible support."
---
