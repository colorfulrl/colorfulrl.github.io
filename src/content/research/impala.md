...
graphEdges:
  ...
  - target: atari
    label: evaluated on
graphDescription: "Espeholt et al. (2018). Decouples actors (environment interaction) from the learner (gradient updates) and corrects the resulting off-policy lag with the V-trace importance-weighting algorithm."
---
