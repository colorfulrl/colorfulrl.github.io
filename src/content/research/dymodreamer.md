...
graphDescription: "Zhang et al. (2025). Inter-frame differencing mask decouples dynamic objects from static background → stochastic categorical modulation injected into RSSM. No representation/decoder model in the architecture (unlike standard Dreamer family) — decoder-free by omission. SOTA Atari 100k 156.6% HNS, DMControl 832, Crafter +9.5%."
graphEdges:
  - target: decoder-free
    label: instance of
