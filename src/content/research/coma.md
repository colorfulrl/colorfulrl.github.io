...
draft: false
graphLabel: "COMA"
graphDescription: "Foerster et al. (2018). Centralized critic + decentralized actors with a counterfactual baseline that marginalizes out one agent's action — solves multi-agent credit assignment ('did my action help, holding others fixed?'). AAAI 2018."
graphEdges:
